...
#define builder_mpresscoord macroPressCoord(x, y); mediaPressCoord(x, y); dualRolesPressCoord(x, y); tapDancePressCoord(x, y); mouseKeysPressCoord(x, y); stickyKeysPressCoord(x, y);
#define builder_mprepress macroPrePress(val, type); mediaPrePress(val, type); dualRolesPrePress(val, type); tapDancePrePress(val, type); mouseKeysPrePress(val, type); stickyKeysPrePress(val, type);
