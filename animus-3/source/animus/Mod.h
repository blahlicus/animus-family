...
#define builder_mod_presscoords ModDualRoles.PressCoords(x, y); ModModifier.PressCoords(x, y);  ModSticky.PressCoords(x, y); ModMedia.PressCoords(x, y); ModMacro.PressCoords(x, y); ModTapdance.PressCoords(x, y); ModMouse.PressCoords(x, y);ModI2CHost.PressCoords(x, y);ModI2CGuest.PressCoords(x, y);
