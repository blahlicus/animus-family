...
key ka('a',0);
key kf1(KEY_F1,0);
key klctrl(KEY_LEFT_CTRL,0);
key kb('b',0);
key kf2(KEY_F2,0);
key krctrl(KEY_RIGHT_CTRL,0);
key kc('c',0);
key kf3(KEY_F3,0);
key klshift(KEY_LEFT_SHIFT,0);
key kd('d',0);
key kf4(KEY_F4,0);
key krshift(KEY_RIGHT_SHIFT,0);
key ke('e',0);
key kf5(KEY_F5,0);
key klalt(KEY_LEFT_ALT,0);
key kf('f',0);
key kf6(KEY_F6,0);
key kralt(KEY_RIGHT_ALT,0);
key kg('g',0);
key kf7(KEY_F7,0);
key klwin(KEY_LEFT_GUI,0);
key kh('h',0);
key kf8(KEY_F8,0);
key krwin(KEY_RIGHT_GUI,0);
key ki('i',0);
key kf9(KEY_F9,0);
key kuarrow(KEY_UP_ARROW,0);
key kj('j',0);
key kf10(KEY_F10,0);
key kdarrow(KEY_DOWN_ARROW,0);
key kk('k',0);
key kf11(KEY_F11,0);
key klarrow(KEY_LEFT_ARROW,0);
key kl('l',0);
key kf12(KEY_F12,0);
key krarrow(KEY_RIGHT_ARROW,0);
key km('m',0);
key kbkspace(KEY_BACKSPACE,0);
key kslock(136+71,0);
key kn('n',0);
key ktab(KEY_TAB,0);
key kprtsc(136+70,0);
key ko('o',0);
key kenter(KEY_RETURN,0);
key kpausebrk(136+72,0);
key kp('p',0);
key kesc(KEY_ESC,0);
key kq('q',0);
key kinsert(KEY_INSERT,0);
key kr('r',0);
key kdelete(KEY_DELETE,0);
key ks('s',0);
key kpup(KEY_PAGE_UP,0);
key kt('t',0);
key kpdown(KEY_PAGE_DOWN,0);
key ku('u',0);
key khome(KEY_HOME,0);
key kv('v',0);
key kend(KEY_END,0);
key kw('w',0);
key kcaps(KEY_CAPS_LOCK,0);
key kx('x',0);
key kmenu(136+101,0);
key ky('y',0);
key kspace(32,0);
...
void inilayout2()
{
  setKeyEEPROM(0, 3, 0, klctrl);
  setKeyEEPROM(1, 3, 0, klwin);
  setKeyEEPROM(2, 3, 0, kfn);
  setKeyEEPROM(3, 3, 0, klalt);
  setKeyEEPROM(4, 3, 0, kspacefn);
  setKeyEEPROM(5, 3, 0, knull);
  setKeyEEPROM(0, 3, 1, klctrl);
  setKeyEEPROM(1, 3, 1, klwin);
  setKeyEEPROM(2, 3, 1, kfn);
  setKeyEEPROM(3, 3, 1, klalt);
  setKeyEEPROM(4, 3, 1, kspacefn);
  setKeyEEPROM(5, 3, 1, knull);
  setKeyEEPROM(0, 3, 2, klctrl);
  setKeyEEPROM(1, 3, 2, klwin);
  setKeyEEPROM(2, 3, 2, kfn);
  setKeyEEPROM(3, 3, 2, klalt);
  setKeyEEPROM(4, 3, 2, kspacefn);
  setKeyEEPROM(5, 3, 2, knull);

  setKeyEEPROM(0, 2, 0, klshift);
  setKeyEEPROM(1, 2, 0, kz);
  setKeyEEPROM(2, 2, 0, kx);
  setKeyEEPROM(3, 2, 0, kc);
  setKeyEEPROM(4, 2, 0, kv);
  setKeyEEPROM(5, 2, 0, kb);
  setKeyEEPROM(0, 2, 1, klshift);
  setKeyEEPROM(1, 2, 1, kz);
  setKeyEEPROM(2, 2, 1, kx);
  setKeyEEPROM(3, 2, 1, kc);
  setKeyEEPROM(4, 2, 1, kv);
  setKeyEEPROM(5, 2, 1, kb);
  setKeyEEPROM(0, 2, 2, klshift);
  setKeyEEPROM(1, 2, 2, kz);
  setKeyEEPROM(2, 2, 2, kx);
  setKeyEEPROM(3, 2, 2, kc);
  setKeyEEPROM(4, 2, 2, kv);
  setKeyEEPROM(5, 2, 2, kb);

  setKeyEEPROM(0, 1, 0, kcaps);
  setKeyEEPROM(1, 1, 0, ka);
  setKeyEEPROM(2, 1, 0, ks);
  setKeyEEPROM(3, 1, 0, kd);
  setKeyEEPROM(4, 1, 0, kf);
  setKeyEEPROM(5, 1, 0, kg);
  setKeyEEPROM(0, 1, 1, kcaps);
  setKeyEEPROM(1, 1, 1, klarrow);
  setKeyEEPROM(2, 1, 1, kdarrow);
  setKeyEEPROM(3, 1, 1, krarrow);
  setKeyEEPROM(4, 1, 1, kf);
  setKeyEEPROM(5, 1, 1, kg);
  setKeyEEPROM(0, 1, 2, kf1);
  setKeyEEPROM(1, 1, 2, kf2);
  setKeyEEPROM(2, 1, 2, kf3);
  setKeyEEPROM(3, 1, 2, kf4);
  setKeyEEPROM(4, 1, 2, kf5);
  setKeyEEPROM(5, 1, 2, kf6);

  setKeyEEPROM(0, 0, 0, ktab);
  setKeyEEPROM(1, 0, 0, kq);
  setKeyEEPROM(2, 0, 0, kw);
  setKeyEEPROM(3, 0, 0, ke);
  setKeyEEPROM(4, 0, 0, kr);
  setKeyEEPROM(5, 0, 0, kt);
  setKeyEEPROM(0, 0, 1, kesc);
  setKeyEEPROM(1, 0, 1, kq);
  setKeyEEPROM(2, 0, 1, kuarrow);
  setKeyEEPROM(3, 0, 1, ke);
  setKeyEEPROM(4, 0, 1, kr);
  setKeyEEPROM(5, 0, 1, kt);
  setKeyEEPROM(0, 0, 2, kaccent);
  setKeyEEPROM(1, 0, 2, k1);
  setKeyEEPROM(2, 0, 2, k2);
  setKeyEEPROM(3, 0, 2, k3);
  setKeyEEPROM(4, 0, 2, k4);
  setKeyEEPROM(5, 0, 2, k5);
