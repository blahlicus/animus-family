...
#define builder_kbname "WP Planck"
#define builder_kbvariant "WP Planck"
#define builder_kbdriver "Animus Renascentia 3"
#define builder_kbdriver_build "WP Planck OEM"
#define builder_vpins 6, 7, 8, 9
#define builder_hpins 10, 16, 14, 15, A0, A1
